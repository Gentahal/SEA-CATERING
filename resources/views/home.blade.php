        ...
        <div class="container py-5 bg-white">
            <div class="row align-items-center py-5">
                <div class="col-lg-6 text-center text-lg-start mb-5 mb-lg-0">
                    <h1 class="display-4 fw-bold mb-4">Healthy Meals, <span style="color: #2a9d8f">Anytime</span>, Anywhere
                    </h1>
                    <p class="lead mb-5">SEA Catering serves high-quality healthy food that can be customized and delivered
                ...
                <div class="col-lg-6">
                    <img src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"
                        alt="Healthy food" class="img-fluid rounded-3 shadow-lg" style="transform: rotate(3deg);">
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm p-4">
                        <div class="feature-icon bg-primary bg-opacity-10  rounded-circle mx-auto mb-4"
                            style="width: 80px; height: 80px; display: flex; align-items: center; justify-content: center;">
                            <i class="fas fa-utensils fa-2x"></i>
                        </div>
                        <div class="card-body text-center">
                            <h5 class="card-title fw-bold">Menu Customization</h5>
                            <p class="card-text text-muted">Choose a healthy menu according to your dietary preferences and
                                tastes with a variety of delicious choices.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm p-4">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text text-muted">Deliver fresh food to all major cities in Indonesia with special
                                packaging.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm p-4">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text text-muted">Complete nutritional details on each menu to support your
                                healthy lifestyle.</p>
                        </div>
                    </div>
                </div>
